// Package main provides a tool to generate TypeScript type definitions from Go structs.
// This enables type-safe communication between the Go backend and TypeScript frontend.
package main
...
// TypeScript type mappings for Go types
...
func main() {
	...
	outputPath := filepath.Join(outputDir, "api.generated.ts")
...
func generateTypeScript() string {
	...
	sb.WriteString(fmt.Sprintf("// Generated by typegen at %s\n", time.Now().Format(time.RFC3339)))
	sb.WriteString("// Run 'make typegen' in the backend directory to regenerate\n\n")
