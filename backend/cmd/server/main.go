...
import (
	...
	"github.com/jacklau/prism/internal/llm/perplexity"
...
func main() {
	...
	// Perplexity AI (API key set via UI)
	perplexityClient := perplexity.NewClient("")
	llmManager.RegisterProvider(perplexityClient)
