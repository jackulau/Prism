...
import (
	...
	"github.com/jacklau/prism/internal/llm/fireworks"
...
func main() {
	...
	// Fireworks AI (API key set via UI)
	fireworksClient := fireworks.NewClient("")
	llmManager.RegisterProvider(fireworksClient)
